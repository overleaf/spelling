...
const modulePath = require('path').join(__dirname, '../../../app/js/SpellingAPIManager');
...
describe("SpellingAPIManager", function() {
	beforeEach(function() {
		...
		return this.SpellingAPIManager = SandboxedModule.require(modulePath, { requires: {
			"./ASpell" : this.ASpell,
	...
	describe("runRequest", function() {
		...
		describe("with sensible JSON", function() {
			beforeEach(function(done) {
				return this.SpellingAPIManager.runRequest(this.token, {words: this.allWords}, (error, result) => { this.result = result; return done(); });
			});
		...
		describe("with a missing words array", function() {
			beforeEach(function(done) {
				return this.SpellingAPIManager.runRequest(this.token, {}, (error, result) => { this.error = error; this.result = result; return done(); });
			});
		...
		describe("with a missing token", function() {
			beforeEach(function(done) {
				return this.SpellingAPIManager.runRequest(null, {words: this.allWords}, (error, result) => { this.error = error; this.result = result; return done(); });
			});
		...
		describe("with a language", function() {
			beforeEach(function(done) {
				...
				}, (error, result) => { this.result = result; return done(); });
			});
		...
		describe("with a very large collection of words", function() {
			beforeEach(function(done) {
				...
				return this.SpellingAPIManager.runRequest(this.token, {words: this.manyWords}, (error, result) => { this.result = result; return done(); });
			});
		...
		return describe('with words from the whitelist', function() {
			beforeEach(function(done) {
				...
				return this.SpellingAPIManager.runRequest(this.token, {words: this.words}, (error, result) => { this.result = result; return done(); });
			});

			return it('should ignore the white-listed word', function() {
				return expect(this.result.misspellings.length).to.equal(this.misspellings.length-1);
			});
		});
	});
	...
	return describe("learnWord", function() {
		describe("without a token", function() {
			beforeEach(function(done) { return this.SpellingAPIManager.learnWord(null, {word: "banana"}, error => { this.error = error; return done(); }); });
		...
		describe("without a word", function() {
			beforeEach(function(done) { return this.SpellingAPIManager.learnWord(this.token, {}, error => { this.error = error; return done(); }); });
		...
		return describe("with a word and a token", function() {
			beforeEach(function(done) {
				this.word = "banana";
				return this.SpellingAPIManager.learnWord(this.token, {word: this.word}, error => { this.error = error; return done(); });
			});
